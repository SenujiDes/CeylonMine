...
const TeamCard = ({ name, role, image, linkedin, github }: TeamMember) => (
  <div className="text-center bg-gray-900 p-6 rounded-lg">
    ...
    <div className="flex justify-center space-x-4">
      {linkedin && (
        <Link href={linkedin} target="_blank" className="text-gray-300 hover:text-white">
      ...
      {github && (
        <Link href={github} target="_blank" className="text-gray-300 hover:text-white">
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
