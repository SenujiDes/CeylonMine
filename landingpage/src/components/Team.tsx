...
const TeamCard = ({ name, role, image, linkedin, github }: TeamMember) => (
  <div className="text-center bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
    ...
    <div className="flex justify-center space-x-4">
      {linkedin && (
        <Link href={linkedin} target="_blank" className="text-gray-600 hover:text-gray-900">
      ...
      {github && (
        <Link href={github} target="_blank" className="text-gray-600 hover:text-gray-900">
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
