...
//           <div className={`logo text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>MARS CAMPERS</div>
          
//           {/* Theme Toggle Button */}
//           <button 
//             onClick={toggleTheme} 
//             className={`p-2 rounded-full ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-900'} hover:opacity-80 transition-all`}
//           >
//             {isDarkMode ? '🌞' : '🌙'}
//           </button>
...
//             <a href="#" className={`hover:text-orange-500 transition-colors ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Home</a>
//             <a href="#" className={`hover:text-orange-500 transition-colors ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Campers</a>
//             <a href="#" className={`hover:text-orange-500 transition-colors ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Features</a>
//             <a href="#" className={`hover:text-orange-500 transition-colors ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>About Us</a>
//             <a href="#" className={`hover:text-orange-500 transition-colors ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Contact</a>
//           </nav>
//         </div>
        
//         {/* Mobile Menu */}
//         <motion.div 
//           className={`absolute top-full left-0 right-0 ${isDarkMode ? 'bg-black bg-opacity-90' : 'bg-white bg-opacity-90'} md:hidden z-20 ${isMenuOpen ? 'block' : 'hidden'}`}
